...
export default function Home(): JSX.Element {
  ...
  useEffect(() => {
    try {
      const saved = typeof window !== "undefined" && localStorage.getItem("fch_theme");
  ...
  return (
    <div className="font-serif antialiased text-gray-900 dark:text-gray-100 dark:bg-slate-900">
      ...
      <section id="about" className="relative min-h-screen bg-[#081f09] flex items-center">
        <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-8 px-6 py-20 items-center">
          <motion.div
          ...
          >
            <h2 className="text-4xl font-extrabold text-stone-100 mb-4">Our Philosophy</h2>
      ...
      {/* EVENTS */}
      <section id="events" className="px-6 py-20 bg-[#131216] text-center">
          ...
          >
            {[
              ...
              return (
                <motion.article
                  key={i}
                  className="rounded-xl p-6 bg-white/3 border border-white/8 text-left"
                  variants={{
      ...
      {/* JOIN */}
      <section id="join" className="px-6 py-20 bg-gradient-to-b from-white/3 to-white/2 text-center dark:from-black/30 dark:to-black/20">
        <div className="max-w-3xl mx-auto">
          <motion.h3
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] }}
            className="text-3xl font-bold text-stone-900 dark:text-stone-100 mb-4"
          >
            Join FC Hacks
          </motion.h3>
          <motion.p
            ...
            className="text-lg text-stone-700 dark:text-stone-200 max-w-2xl mx-auto leading-relaxed mb-6"
          >
